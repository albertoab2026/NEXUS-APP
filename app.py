...
with tab_ventas:
    if st.session_state.ultima_boleta:
        ...
        # DISEÑO MEJORADO: Letras más grandes, negras y borde completo
        st.markdown(f"""
        <div style="background-color: white !important; color: black !important; padding: 30px; border: 3px solid black; max-width: 600px; margin: auto; font-family: Arial, sans-serif;">
            <div style="text-align: center;">
                <h1 style="color: black !important; margin-bottom: 5px; font-size: 40px;">🦷 BALLARTA</h1>
                <p style="color: black !important; font-size: 18px; font-weight: bold;">Insumos y Suministros Dentales</p>
                <p style="color: black !important; font-size: 16px;">Carabayllo, Lima</p>
                <hr style="border: 1px solid black;">
            </div>
            <div style="font-size: 20px; color: black !important;">
                <p><b>FECHA:</b> {b['fecha']}</p>
                <p><b>HORA:</b> {b['hora']}</p>
                <hr style="border: 1px solid black;">
                <table style="width: 100%; border-collapse: collapse; font-size: 20px; color: black !important;">
        ...
        for item in b['items']:
            st.markdown(f"""
                    <tr style="border-bottom: 1px solid #ddd;">
                        ...
                        <td style="padding: 10px; text-align: right;">S/ {float(item['Subtotal']):.2f}</td>
                    </tr>
            """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
                ...
                <br>
                <div style="text-align: right; font-size: 28px; font-weight: bold; color: black !important;">
                    TOTAL A PAGAR: S/ {b['total']:.2f}
                </div>
                <hr style="border: 1px solid black;">
                <p style="font-size: 18px;"><b>MÉTODO DE PAGO:</b> {b['metodo']}</p>
                <div style="text-align: center; margin-top: 30px;">
                    <h3 style="color: black !important; font-size: 22px;">¡Gracias por su preferencia!</h3>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
